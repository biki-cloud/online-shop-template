ALTER TABLE "cart_items" ALTER COLUMN "id" SET DATA TYPE serial;--> statement-breakpoint
...
ALTER TABLE "push_subscriptions" ALTER COLUMN "id" SET DATA TYPE serial;--> statement-breakpoint
